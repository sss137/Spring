...
public class MvcControllerA {
   ...
   *    2) 메소드 레벨: 세부 요청 주소(예시: /board/list, /board/detail 등)를 지정
   * 4. 스프링 4.3부터는 HTTP 메소드 별로 간결한 축약 어노테이션을 제공합니다.(예시: @GetMapping, @PostMapping 등) 
   */
  ...
  public String methodA() {
    ...
    /*
     * return "a/list" 처리 과정
     * 1. 반환값 "a/list"는 ViewResoiver에게 전달됩니다.(ViewResolver는 servlet-context.xml에서 확인할 수 있습니다.)
     * 2. ViewResolver는 prefix값을 반환값 앞에 추가하고 suffix값을 반환값 뒤에 추가합니다.
